    ...
    <div className='flex flex-col gap-8 my-8 px-5'>
      ...
      <div className='grid grid-cols-4 gap-4'>
        <div className='flex drop-shadow-lg flex-col gap-5 items-center'>
            <Image src='/breakfast.webp' width={200} height={200} alt='recipe' className='rounded-full w-40 h-40'/>
            <h2 className='text-black font-semibold text-xl '>BreakFast</h2>
        </div>
        <div className='flex drop-shadow-lg flex-col gap-4 items-center'>
            <Image src='/lunch.webp' width={200} height={200} alt='recipe' className='rounded-full w-40 h-40'/>
            <h2 className='text-black font-semibold text-xl '>Lunch</h2>
        </div>
        <div className='flex drop-shadow-lg flex-col gap-4 items-center'>
            <Image src='/dinner.webp' width={200} height={200} alt='recipe' className='rounded-full w-40 h-40'/>
            <h2 className='text-black font-semibold text-xl '>Dinner</h2>
        </div>
        <div className='flex drop-shadow-lg flex-col gap-4 items-center'>
            <Image src='/salad.webp' width={200} height={200} alt='recipe' className='rounded-full w-40 h-40'/>
            <h2 className='text-black font-semibold text-xl '>Salad</h2>
        </div>
        <div className='flex drop-shadow-lg flex-col gap-4 items-center'>
            <Image src='/sweets.webp' width={200} height={200} alt='recipe' className='rounded-full w-40 h-40'/>
            <h2 className='text-black font-semibold text-xl '>Sweets</h2>
        </div>
        <div className='flex drop-shadow-lg flex-col gap-4 items-center'>
            <Image src='/pizza.webp' width={200} height={200} alt='recipe' className='rounded-full w-40 h-40'/>
            <h2 className='text-black font-semibold text-xl '>Pizza</h2>
        </div>
        <div className='flex drop-shadow-lg flex-col gap-4 items-center'>
            <Image src='/drinks.webp' width={200} height={200} alt='recipe' className='rounded-full w-40 h-40'/>
            <h2 className='text-black font-semibold text-xl '>Drinks</h2>
        </div>
        <div className='flex flex-col gap-4 items-center drop-shadow-lg'>
            <Image src='/appetizer.webp' width={200} height={200} alt='recipe' className='rounded-full w-40 h-40'/>
